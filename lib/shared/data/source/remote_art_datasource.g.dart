...
part of 'remote_art_datasource.dart';
...
class _RemoteArtDatasource implements RemoteArtDatasource {
  _RemoteArtDatasource(this._dio, {this.baseUrl, this.errorLogger});
